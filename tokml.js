...
function excludeStyleProperties(property, key) {
    const styles = ['stroke', 'stroke-width', 'stroke-opacity', 'fill', 'fill-opacity'];
...
},{"lodash":2,"strxml":3}],2:[function(require,module,exports){
(function (global){
/**
 * @license
